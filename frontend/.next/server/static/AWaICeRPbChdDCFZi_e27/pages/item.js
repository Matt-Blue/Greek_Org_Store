  ...
  _createClass(SingleItem, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        if (!data.item) return external_react_default.a.createElement("p", null, "No item found for id: ", _this.props.id);
        var item = data.item;
        return external_react_default.a.createElement(SingleItemStyles, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "Sick Fits | ", item.title)), external_react_default.a.createElement("div", {
          className: "details"
        }, external_react_default.a.createElement("h2", null, "Viewing ", item.title), external_react_default.a.createElement("p", null, item.description)), external_react_default.a.createElement("img", {
          src: item.largeImage,
          alt: item.title
        }));
      });
