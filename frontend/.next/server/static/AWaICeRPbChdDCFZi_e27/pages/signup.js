...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n    mutation SIGNUP_MUTATION($email: String!, $password: String!, $name: String!, $organization: String!, $inOrg: Boolean!) {\n        signup(email : $email, name : $name, password: $password, organization: $organization, inOrg: $inOrg) {\n            id\n            email\n            name\n            organization\n            inOrg\n        }\n    }\n"]);
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        return external_react_default.a.createElement(Form["a" /* default */], {
          ...
          disabled: loading,
          "aria-busy": loading
        }, external_react_default.a.createElement("h2", null, " Sign up here!"), external_react_default.a.createElement(ErrorMessage["a" /* default */], {
          error: error
...
function (_Component) {
  ...
  function Signin() {
    ...
    _this = RequestReset_possibleConstructorReturn(this, (_getPrototypeOf2 = RequestReset_getPrototypeOf(Signin)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        return external_react_default.a.createElement(Form["a" /* default */], {
          ...
          disabled: loading,
          "aria-busy": loading
        }, external_react_default.a.createElement("h2", null, " Request password reset."), external_react_default.a.createElement(ErrorMessage["a" /* default */], {
          error: error
        }), !error && !loading && called && external_react_default.a.createElement("p", null, "Success! Check email for reset link!"), external_react_default.a.createElement("label", {
          htmlFor: "email"
        }, "Email", external_react_default.a.createElement("input", {
          type: "email",
          name: "email",
...
var signup_SignupPage = function SignupPage(props) {
  return external_react_default.a.createElement(Columns, null, external_react_default.a.createElement(components_Signup, null), external_react_default.a.createElement(components_Signin["a" /* default */], null), external_react_default.a.createElement(RequestReset, null));
};
